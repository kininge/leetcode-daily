...
const easyCardImage = `<svg xmlns="http://www.w3.org/2000/svg" width="${sectionCardWidth+4}" height="${sectionCardHeight+4}" viewBox="0 0 ${sectionCardWidth+4} ${sectionCardHeight+4}">
  ...
  <g transform="translate(${70-((solvedEasyProblems.toString().length-1)*8)}, 90)" text-anchor="middle">
    ...
    <text font-size="${sectionCardSecondaryTextFontSize}" font-weight="600" font-family="${fontfamily}" fill="${secondaryTextColor}" dominant-baseline="end" dx="${45+((solvedEasyProblems.toString().length-1)*8)}">/ ${totalEasyProblems}</text>
  </g>
</svg>`;
...
const mediumCardImage = `<svg xmlns="http://www.w3.org/2000/svg" width="${sectionCardWidth+4}" height="${sectionCardHeight+4}" viewBox="0 0 ${sectionCardWidth+4} ${sectionCardHeight+4}">
  ...
  <g transform="translate(${70-((solvedMediumProblems.toString().length-1)*8)}, 90)" text-anchor="middle">
    ...
    <!-- section problems available -->
    <text font-size="${sectionCardSecondaryTextFontSize}" font-weight="600" font-family="${fontfamily}" fill="${secondaryTextColor}" dominant-baseline="end" dx="${45+((solvedMediumProblems.toString().length-1)*8)}">/ ${totalMediumProblems}</text>
  </g>
</svg>`;
...
const hardCardImage = `<svg xmlns="http://www.w3.org/2000/svg" width="${sectionCardWidth+4}" height="${sectionCardHeight+4}" viewBox="0 0 ${sectionCardWidth+4} ${sectionCardHeight+4}">
  ...
  <g transform="translate(${70-((solvedHardProblems.toString().length-1)*8)}, 90)" text-anchor="middle">
    <!-- section problems solved -->
    ...
    <!-- section problems available -->
    <text font-size="${sectionCardSecondaryTextFontSize}" font-weight="600" font-family="${fontfamily}" fill="${secondaryTextColor}" dominant-baseline="end" dx="${45+((solvedHardProblems.toString().length-1)*8)}">/ ${totalHardProblems}</text>
  </g>
</svg>`;
